# Streamdata.io API Gallery - Insomnia Rest Client Profiling
This is a repository for managing the profiling of Insomnia Rest Client. Right now, it is just a Github repository, README, and an [APIs.json](apis.md) outlining some of the details of Insomnia Rest Client, including different links and artificats defining their operation.
...
Once there is an OpenAPI for Insomnia Rest Client, it will be available within the [Streamdata.io API Gallery](http://api.gallery.streamdata.io/), until then the companies profile will be used in a variety of other sites and applications.
